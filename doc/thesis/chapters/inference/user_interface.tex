...
The small differences are due to background tasks of the Linux operating system (see section \ref{}). % todo: reference to section 'verification_and_benchmark' throughput
