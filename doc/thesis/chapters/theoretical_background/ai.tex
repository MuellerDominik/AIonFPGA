...
% Through the means of a performance measure ... evaluated
% Agents are evaluated by a performance
% How well an agent performs in its environment is evaluated by a performance measure.
