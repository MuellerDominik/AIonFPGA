...
Since \texttt{user/local/lib} is not a default path for dynamic libraries, a file with a filename ending with .conf must be created in the \texttt{/etc/ld.so.conf.d/} folder.
