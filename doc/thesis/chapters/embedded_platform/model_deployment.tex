...
% It therefore removes as many trailing charachters until the last charachter is not contained in the specified sequence.
% everything from the end of the specified name until there is no s or \_0.
