...
For this reason, it is highly beneficial to weight the frames according to their occurrence in the throw (see section \ref{subsec:inference:app:weighting}). % or position on the throw?
