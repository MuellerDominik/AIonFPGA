...
% dataset for training with Python scripts is created.
...
% Due to the quantization, the Top-1 accuracy was affected, but one frame can be recognized within \SI{7.422}{ms}.
...
% If the processor had been a little more powerful, this setup would also have made it possible to run image acquisition, image processing and image recognition in parallel.
