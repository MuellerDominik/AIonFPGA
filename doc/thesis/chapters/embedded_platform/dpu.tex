...
\todo[inline]{Split DPU into two files}
...
% cite: https://www.element14.com/community/groups/power-management/blog/2020/01/23/infineon-pmic-updates-to-avnet-products
...
\begin{table}[hb]
  \caption{Parallelism for Different Convolution Architectures } % cite: https://www.xilinx.com/support/documentation/ip_documentation/dpu/v3_1/pg338-dpu.pdf 
  ...
  \end{tabular}
\end{table}
\todo[inline]{Umbrüche bei den Titeln, Tabelle überhaupt nötig / nur Architekturen itemizen?}
...
\todo[inline]{?? makes no sence, overfitting is no problem in inference, is it a parameter while training?}
...
\todo[inline]{listing für diesen komischen Code? (sieht aber schon okee aus)}
